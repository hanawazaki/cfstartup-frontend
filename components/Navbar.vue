      ...
      <div class="dropdown inline-block relative z-10">
        ...
        >
          <li>
            <nuxt-link
              to="/dashboard"
              class="bg-white hover:bg-gray100 hover:text-orange-500 py-2 px-4 block whitespace-no-wrap"
              >My Dashboard
            </nuxt-link>
          </li>
          <li>
          ...
          <li>
            <a
              @click="logout()"
              class="cursor-pointer rounded-b bg-white hover:bg-gray100 hover:text-orange-500 py-2 px-4 block whitespace-no-wrap"
              >Logout
            </a>
          </li>
        </ul>
